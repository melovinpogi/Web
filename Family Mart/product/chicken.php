          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  ...
                  <p class='featured-title-desc-main'>CHICKEN POPPERS</p>

                  <p class='featured-desc-main'>Tired of the same old boring snacks? Get ready for a POPping good treat with FamilyMart's deliciously crunchy Chicken Poppers.Choose your favorite flavor and shake it!



                  </p>

                  <a href='info/chicken-popper.php' class='btn btn-orange' style='margin-left: 20px;margin-bottom: 10px'>Know More</a>

                </div>

                <div class='featured-product-display-img'>

                  <img src='../img/chicken-poppers-prod-info.jpg' class='img-responsive'>
                ...
                <div class='row'>
                  ...
                  <div class='col-md-4'>
                    ...
                    <div  class='product'  style=''>
                        ...
                        <img src="../img/chicken/chicken-rice-meal.png" alt="..." >

                        <br>

                        <a href='info/chicken-ricemeal.php' class='btn btn-orange'>Chicken Rice Meal</a>
                  ...
                  <div class='col-md-4'>
                    ...
                    <div  class='product'  style=''>
                        ...
                        <img  src="../img/chicken/2pc-chicken-rice-meal.png" alt="..." >

                        <br>

                        <a href='info/2pc-chicken-ricemeal.php' class='btn btn-orange'>2PC Chicken Rice Meal</a>
                  ...
                  <div class='col-md-4'>
                    ...
                    <div class='product'>
                        ...
                        <img   src="../img/chicken/chicken-nuggets.png" alt="..." >

                        <br>

                        <a href='info/chicken-nuggets.php' class='btn btn-orange' >Chicken Nuggets</a>
                ...
                <div class='row'>
                  ...
                  <div class='col-md-4'>
                    ...
                    <div  class='product'  style=''>
                        ...
                        <img src="../img/chicken/chicken-bucket-a.png" alt="..." >

                        <br>

                        <a href='info/chicken-bucket.php' class='btn btn-orange'>Chicken Bucket</a>
                  ...
                  <div class='col-md-4'>
                    ...
                    <div  class='product'  style=''>
                        ...
                        <img  src="../img/chicken/chicken-drum-stick-a.png" alt="..." >

                        <br>

                        <a href='info/chicken-drumstick.php' class='btn btn-orange'>Chicken Ala Carte</a>
                  ...
                  <div class='col-md-4'>
                    ...
                    <div class='product'>
                        ...
                        <img   src="../img/chicken/chicken-popper.png" alt="..." >

                        <br>

                        <a href='info/chicken-popper.php' class='btn btn-orange'>Chicken Poppers</a>
