            ...
            <div class='product-main-wrapper'>
              <div class='product-main'>
                <div class='row'>
                  ...
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        ...
                        <br>
                        <button class='btn btn-orange'>Hotdog Sandwich</button>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                  ...
                  <div class='col-md-4'>
                    <div class='product'>
                        ...
                        <br>
                        <button  class='btn btn-orange' >Twirl</button>
                    </div>
                  </div>
                  </center>
                </div>
                ...
                <div class='row'>
                  ...
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img src="../img/arroz-prod-info.png" alt="..." >
                        <br>
                        <button class='btn btn-orange'>Arroz Caldo</button>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img  src="../img/lumpia-prod-info.png" alt="..." >
                        <br>
                        <button class='btn btn-orange'>Lumpiang Gulay</button>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div class='product'>
                        <img   src="../img/cookies-prod-info.png" alt="..." >
                        <br>
                        <button  class='btn btn-orange'>Cookies</button>
                    </div>
                  </div>
                  </center>
                </div>
