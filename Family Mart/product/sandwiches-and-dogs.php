          ...
          <div class='product-wrapper'>
                ...
                <div class='filter-products'>
                  ...
                  <div class='input-group'>
                    ...
                    <select class="form-control" name='filter' id='filter' style='background-color:#fff;color: #968d8d;border-top: 2px solid #00ae4c;border-bottom: 2px solid #00ae4c;border-right: 1px solid #00ae4c;border-left : 0px;'>
                      ...
                      <option value='Sandwiches and Dogs' selected="">Sandwiches and Dogs</option>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  ...
                  <p class='featured-title-desc-main'>Sandwiches and Dogs</p>

                  <p class='featured-desc-main'>Choose from a delectable selection of freshly made and delightfully filling sandwiches, for that perfect and quick start to your day! Grab one now at your nearest FamilyMart! 



                  </p>

                  <a href='' class='btn btn-orange' style='margin-left: 20px;margin-bottom: 10px'>Know More</a>

                </div>

                <div class='featured-product-display-img'>

                  <img src='../img/sandwiches-and-dogs-prod-info.jpg' class='img-responsive'>
                ...
                <div class='row'>
                  ...
                  <div class='col-md-4'>
                    ...
                    <div  class='product'  style=''>
                        ...
                        <img src="../img/sandwiches-and-dogs/chicken-bacon-egg-salad-sandwich.png" alt="..." >

                        <br>

                        <a href='info/chicken-bacon-egg-salad-sandwich.php' class='btn btn-orange'>Chicken Salad Sandwich</a>
                  ...
                  <div class='col-md-4'>
                    ...
                    <div  class='product'  style=''>
                        ...
                        <img  src="../img/sandwiches-and-dogs/chicken-cheese-corndog.png" alt="..." >

                        <br>

                        <a href='info/chicken-cheese-corndog.php' class='btn btn-orange'>Chicken Cheese Corndog</a>
                  ...
                  <div class='col-md-4'>
                    ...
                    <div class='product'>
                        ...
                        <img   src="../img/sandwiches-and-dogs/mango-kani-sandwich.png" alt="..." >

                        <br>

                        <a href='info/mango-kani-sandwich.php' class='btn btn-orange' style='font-size: 10px;'>Kani and Mango on White Bread</a>
                ...
                <div class='row'>
                  ...
                  <div class='col-md-4'>
                    ...
                    <div  class='product'  style=''>
                        ...
                        <img src="../img/sandwiches-and-dogs/smoked-ham-w-swisscheese-sandwich.png" alt="..." >

                        <br>

                        <a href='info/smoked-ham-w-swisscheese-sandwich.php' class='btn btn-orange' style='font-size: 10px;'>Smoked Ham w Swisscheese Sandwich</a>
                  ...
                  <div class='col-md-4'>
                    ...
                    <div  class='product'  style=''>
                        ...
                        <img  src="../img/sandwiches-and-dogs/tj-corndog.png" alt="..." >

                        <br>

                        <a href='info/tj-corndog.php' class='btn btn-orange'>Tj Corndog</a>
                  ...
                  <div class='col-md-4'>
                    ...
                    <div class='product'>
                        ...
                        <img   src="../img/sandwiches-and-dogs/turkey-ham-w-raspberry-creamcheese-sandwich.png" alt="..." >

                        <br>

                        <a href='info/turkey-ham-w-raspberry-creamcheese-sandwich.php' class='btn btn-orange' style='font-size: 10px;'>Turkey Ham w Raspberry Creamcheese</a>
