          ...
          <div class='product-wrapper'>
                ...
                <div class='filter-products'>
                  <div class='input-group'>
                    ...
                    <select class="form-control" name='filter' id='filter' style='background-color:#fff;color: #968d8d;border-top: 2px solid #00ae4c;border-bottom: 2px solid #00ae4c;border-right: 1px solid #00ae4c;border-left : 0px;'>
                      ...
                      <option value='Savories' selected="">Hot Savories</option>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc-main'>CORNED BEEF AND TUNA PANDESAL</p>
                  <p class='featured-desc-main'>The classic Corned Beef and Tuna, in an on-the-go treat! Savor the Corned Beef-filled and Tuna-filled Pandesal today.
                  </p>
                  <a class='btn btn-orange' style='margin-left: 20px;margin-bottom: 10px'>Know More</a>
                </div>
                <div class='featured-product-display-img'>
                  <img src='../img/hot-pandesal-prod-info.jpg' class='img-responsive'>
                </div>
            ...
            <div class='product-main-wrapper'>
              <div class='product-main'>
                <div class='row'>
                  ...
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img src="../img/savories/tuna-pandesal.png" alt="..." >
                        <br>
                        <button class='btn btn-orange'>Tuna Pandesal</button>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img   src="../img/savories/corned-beef-pandesal.png" alt="..." >
                        <br>
                        <button  class='btn btn-orange' >Corned Beef Pandesal</button>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div class='product'>
                        <img src="../img/savories/empanada.png" alt="..." >
                        <br>
                        <button class='btn btn-orange'>Empanada</button>
                    </div>
                  </div>
                  </center>
                </div>
                ...
                <div class='row'>
                  ...
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img  src="../img/savories/jamaican-beef-empanada.png" alt="..." >
                        <br>
                        <button class='btn btn-orange'>Jamaican Beef Empanada</button>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img src="../img/savories/turon.png" alt="..." >
                        <br>
                        <button class='btn btn-orange'>Turon</button>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div class='product'>
                        <img  src="../img/savories/lumpiang-shanghai.png" alt="..." >
                        <br>
                        <button class='btn btn-orange'>Lumpiang Shanghai</button>
                    </div>
                  </div>
                  </center>
                </div>
