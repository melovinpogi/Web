          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Tocilog</p>
                  <p class='featured-desc'>Juicy, Savory Tocino cooked eggsquisitely with scrambled eggs!
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img src='../img/product-info/tocilog.png' class='img-responsive'>
                </div>
                ...
                <div class="carousel-inner" role="listbox">
                  ...
                  <div class='col-md-4'>
                    <div class='product'>
                        ...
                        <br>
                        <a href='tapsilog-info.php'  class='btn btn-orange' >Tapsilog</a>
                    </div>
                  </div>
                  </center>
                </div>
