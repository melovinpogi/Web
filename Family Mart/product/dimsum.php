          ...
          <div class='product-wrapper'>
                ...
                <div class='filter-products'>
                  <div class='input-group'>
                    ...
                    <select class="form-control" name='filter' id='filter' style='background-color:#fff;color: #968d8d;border-top: 2px solid #00ae4c;border-bottom: 2px solid #00ae4c;border-right: 1px solid #00ae4c;border-left : 0px;'>
                      ...
                      <option value='Dimsum'  selected="">Dimsum</option>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc-main'>Hong kong Style Street Food</p>
                  <p class='featured-desc-main'>Go crazy on your next merienda and take your snacking to a different level by trying FamilyMart's Hong Kong Style Street Food! Choose from fried hakaw, stuffed fish balls, and lobster balls.
                  </p>
                  <a class='btn btn-orange' style='margin-left: 20px;margin-bottom: 10px'>Know More</a>
                </div>
                <div class='featured-product-display-img'>
                  <img src='../img/street-food-prod-info.jpg' class='img-responsive'>
                </div>
            ...
            <div class='product-main-wrapper'>
              <div class='product-main'>
                <div class='row'>
                  ...
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img src="../img/dimsum/fried-hakaw.png" alt="..." >
                        <br>
                        <button class='btn btn-orange'>Fried Hakaw</button>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img  src="../img/dimsum/kwek-kwek.png" alt="..." >
                        <br>
                        <button class='btn btn-orange'>Kwek-kwek</button>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div class='product'>
                        <img   src="../img/dimsum/lobster-balls.png" alt="..." >
                        <br>
                        <button  class='btn btn-orange' >Lobster Balls</button>
                    </div>
                  </div>
                  </center>
                </div>
                ...
                <div class='row'>
                  ...
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img src="../img/dimsum/siomai.png" alt="..." >
                        <br>
                        <button class='btn btn-orange'>Siomai</button>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img  src="../img/dimsum/siopaos.png" alt="..." >
                        <br>
                        <button class='btn btn-orange'>Siopao</button>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div class='product'>
                        <img   src="../img/dimsum/stuffed-fish-balls.png" alt="..." >
                        <br>
                        <button  class='btn btn-orange'>Stuffed Fish Balls</button>
                    </div>
                  </div>
                  </center>
                </div>
