          ...
          <div class='product-wrapper'>
                ...
                <div class='filter-products'>
                  <div class='input-group'>
                    ...
                    <select class="form-control" name='filter' id='filter' style='background-color:#fff;color: #968d8d;border-top: 2px solid #00ae4c;border-bottom: 2px solid #00ae4c;border-right: 1px solid #00ae4c;border-left : 0px;'>
                      ...
                      <option value='Rice Meals' selected="">Rice Meals</option>
                      <option value='Sandwiches and Dogs' >Sandwiches and Dogs</option>
                      <option value='Drinks'>Drinks</option>
                      <option value='Desserts'>Desserts</option>
                      <option value='Japanese Treats'>Japanese text-right ats</option>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Cornsilog</p>
                  <p class='featured-desc'>Rice and shine! Nothing better than starting your day off with a plate of Cornsilog.
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img src='../img/product-info/cornsilog.png' class='img-responsive'>
                </div>
            ...
            <div class='product-info-wrapper'>
              ...
              <div class='product-desc-wrapper'>
                ...
                <div class='product-info-desc2'>
                  ...
                  <hr class='hr2'>
                  <p class='srp text-left'>PHP 69</p>
              ...
              <p class='see-more-p' style='margin-left: 25px;color: #fff;'>See more rice meals</p>
                ...
                <div class="carousel-inner" role="listbox">
                  ...
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img src="../img/ricemeals/tocilog.png" alt="..." >
                        <br>
                        <a href='tocilog-info.php' class='btn btn-orange'>Tocilog</a>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img  src="../img/ricemeals/hotsilog.png" alt="..." >
                        <br>
                        <a href='hotsilog-info.php' class='btn btn-orange'>Hotsilog</a>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div class='product'>
                        <img   src="../img/ricemeals/tapsilog.png" alt="..." >
                        <br>
                        <a href='cornsilog-info.php'  class='btn btn-orange' >Tapsilog</a>
                    </divtapsilog                  </div>
                  </center>
                </div>
