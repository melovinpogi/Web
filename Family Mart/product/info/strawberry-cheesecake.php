          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Strawberry Cheesecake</p>
                  <p class='featured-desc'>Make it just like your first dance! Twirl the Strawberry flavored ice-cream to be there for you through the heat!
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img  src='../../img/product-info/desserts/strawberry-cheesecake.png' class='img-responsive'>
                </div>
