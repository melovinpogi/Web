          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Ebi Tempura</p>
                  <p class='featured-desc'>Chomp chomp! Relish in the authentic flavors of Ebi Tempura!
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img  src='../../img/treats/ebi-tempura.png' class='img-responsive'>
                </div>
