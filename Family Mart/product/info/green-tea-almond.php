          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Green Tea Almond Donut</p>
                  <p class='featured-desc'>Go green with the almond-y goodness of Green Tea Almond Donut!
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img  src='../../img/product-info/desserts/green-tea-almond.png' class='img-responsive'>
                </div>
