          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Chicken Rice Meal (1pc)</p>
                  <p class='featured-desc'>Savor the moment together with the juicy goodness of fried chicken with a hot steaming rice on the side.
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img height="358" width="555" src='../../img/product-info/chicken/chicken-rice-meal.png' class='img-responsive'>
                </div>
            ...
            <div class='product-info-wrapper'>
              ...
              <div class='product-desc-wrapper'>
                ...
                <div class='product-info-desc2'>
                  ...
                  <hr class='hr2'>
                  <p class='srp text-left'>PHP 89</p>
                ...
                <div class="carousel-inner" role="listbox">
                  ...
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        ...
                        <br>
                        <a href='chicken-popper.php'  class='btn btn-orange' >Chicken Poppers</a>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div class='product'>
