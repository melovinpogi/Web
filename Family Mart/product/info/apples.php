        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
              ...
              <li><a href="../../snapc/" class="second-nav">Snap Card</a></li>
          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Apples</p>
                  <p class='featured-desc'>Keep the doctor away with sliced apples in a cup.
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img height="300" width="232" src='../../img/product-info/desserts/apples.png' class='img-responsive'>
                </div>
            ...
            <div class='product-info-wrapper'>
              ...
              <div class='product-desc-wrapper'>
                ...
                <div class='product-info-desc2'>
                  ...
                  <hr class='hr2'>
                  <p class='srp text-left'>PHP 35</p>
