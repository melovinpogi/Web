          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Mango Taho</p>
                  <p class='featured-desc'>Man-GO and delight yourself in the tangy flavor of the Mango Taho!
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img  src='../../img/product-info/desserts/mango-taho.png' class='img-responsive'>
                </div>
