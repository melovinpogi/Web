          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Chocolate Glaze Donut</p>
                  <p class='featured-desc'>Race down to the aisle with the Chocolate Glaze Donut!
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img  src='../../img/product-info/desserts/choco-glaze-donut.png' class='img-responsive'>
                </div>
