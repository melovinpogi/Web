          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Banana Muffin</p>
                  <p class='featured-desc'>Go bananas with banana muffin!
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img  src='../../img/product-info/desserts/banana-muffin-2.png' class='img-responsive'>
                </div>
