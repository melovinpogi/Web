          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Futo Maki 4pcs</p>
                  <p class='featured-desc'>Oh snap! Take the perfect selfie with the 4pcs. Futo Maki Sushi Roll!  
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img  src='../../img/treats/sushi-4pcs.png' class='img-responsive'>
                </div>
