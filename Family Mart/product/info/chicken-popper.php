          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Chicken Poppers</p>
                  <p class='featured-desc'>
Tired of the same old boring snacks? Get ready for a POPping good treat with FamilyMart's deliciously crunchy Chicken Poppers.
Choose your favorite flavor and shake it!

                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img height="358" width="555" src='../../img/product-info/chicken/chicken-popper.png' class='img-responsive'>
                </div>
            ...
            <div class='product-info-wrapper'>
              ...
              <div class='product-desc-wrapper'>
                ...
                <div class='product-info-desc2'>
                  ...
                  <hr class='hr2'>
                  <p class='srp text-left'>PHP 59</p>
                ...
                <div class="carousel-inner" role="listbox">
                  ...
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        ...
                        <br>
                        <a href='chicken-ricemeal.php' class='btn btn-orange'>Chicken Rice Meal</a>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        ...
                        <br>
                        <a href='2pc-chicken-ricemeal.php'  class='btn btn-orange' >2PC Chicken Rice Meal</a>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div class='product'>
                        ...
                        <br>
                        <a href='chicken-bucket.php'  class='btn btn-orange' >Chicken Bucket</a>
                    </div>
                  </div>
                  </center>
                </div>
                  ...
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        ...
                        <br>
                        <a href='chicken-nuggets.php' class='btn btn-orange'>Chicken Nuggets</a>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        ...
                        <br>
                        <a href='chicken-drumstick.php'  class='btn btn-orange' >Chicken Ala Carte</a>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div class='product'>
