          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Vanilla Strawberry</p>
                  <p class='featured-desc'>Take it by the hand! Twirl the Strawberries and Cream flavored ice-cream and let the flavors dance in your mouth.
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img  src='../../img/product-info/desserts/vanilla-strawberry.png' class='img-responsive'>
                </div>
