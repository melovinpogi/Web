          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Mocha White Chocolate</p>
                  <p class='featured-desc'>Turn locca with the Mocha White Chocolate Donut!
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img  src='../../img/product-info/desserts/mocha-white-choc.png' class='img-responsive'>
                </div>
