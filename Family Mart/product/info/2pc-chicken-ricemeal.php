          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>2PC Chicken Rice Meal</p>
                  <p class='featured-desc'>Double the fun! Enjoy two hot and crispy pieces of fried chicken paired with the perfect side dish.
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img height="358" width="555" src='../../img/product-info/chicken/2pc-chicken-rice-meal.png' class='img-responsive'>
                </div>
            ...
            <div class='product-info-wrapper'>
              ...
              <div class='product-desc-wrapper'>
                ...
                <div class='product-info-desc2'>
                  ...
                  <hr class='hr2'>
                  <p class='srp text-left'>PHP 105</p>
