          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Beef Yakiniku</p>
                  <p class='featured-desc'>Beef beef! Get through the traffic rush with the Beef Yakiniku Bento Box.
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img  src='../../img/treats/beef-yakiniku.png' class='img-responsive'>
                </div>
