                  ...
                  <div class="item active">
                    <center>
                      <div   class='product' style='display:  inline-block; '>
                        <img class='' class='' src="../img/prod2.png" alt="..." >
                        <br>
                      ...
                      <div  class='product'  style='display:  inline-block; '>
                        <img class='' src="../img/prod3.png" alt="..." >
                        <br>
                        <button class='btn' style='background-color: #cc7e21;border:1.5px dashed #fff;width:150px;color:#fff;border-radius:8px;'>Siopao</button>
                      </div>
                      <div  class='product' style='display:  inline-block; '>
                        <img class=''  src="../img/prod1.png" alt="..." >
                        <br>
                        <button  class='btn' style='background-color: #cc7e21;border:1.5px dashed #fff;width:150px;color:#fff;border-radius:8px;'>Twirl</button>
                      </div>
                      </center>
