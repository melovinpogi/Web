          ...
          <div class='product-wrapper'>
            ...
            <div class='featured-product-display-wrapper'>
                ...
                <div class='featured-product-display-txt'>
                  <p class='featured-title-desc'>Hotsilog</p>
                  <p class='featured-desc'>Keepin' it Hot and Fresh with our delicious Hotsilog! 
                  </p>
                </div>
                <div class='featured-product-display-img'>
                  <img src='../img/product-info/hotsilog.png' class='img-responsive'>
                </div>
            ...
            <div class='product-info-wrapper'>
              ...
              <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" id="carousel-meals">
                ...
                <div class="carousel-inner" role="listbox">
                  ...
                  <div class='col-md-4'>
                    <div  class='product'  style=''>
                        <img  src="../img/ricemeals/cornsilog.png" alt="..." >
                        <br>
                        <a href='cornsilog-info.php' class='btn btn-orange'>Cornsilog</a>
                    </div>
                  </div>
                  <div class='col-md-4'>
                    <div class='product'>
