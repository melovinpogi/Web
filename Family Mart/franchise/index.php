...
$sql = "SELECT * FROM content where page_name = 'franchise'";
    ...
    <!--
      ...
      <header id="franchise">
          ...
          <div class='franchise-wrapper'>
            ...
            <div class='franchise-wrapper-2'>

              <div class='container'>

                <div class='franchise-wrapper-inner'>

                  <div class='row'>

                    <div class='col-md-6'>

                      <div class='franchise-text-wrapper'>

                          <p class='franchise-title'><?php echo $t1; ?></p>
              ...
              <div class='container-fluid'>
                ...
                <div class='row'>
                  ...
                  <div class='col-md-12'>
                    ...
                    <img src='<?php echo $i2; ?>' class='img-responsive '>
