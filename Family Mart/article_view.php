	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
					<?php echo form_open_multipart('article/submit'); ?>
					...
					<ul class="nav nav-tabs">
						<?php
							foreach ($category as $value) { ?>
								 <li class="<?php  if($value->category == 'more-in-ph'){echo "active";}?>">
					...
					<div class="tab-content">
						<?php
							...
							<div id="<?php echo str_replace(' ','',$value->category);?>" 
								class="tab-pane fade <?php  if($value->category == 'more-in-ph'){echo "in active";}?>">
								<?php
