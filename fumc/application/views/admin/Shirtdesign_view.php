...
<?php $this->load->view('menu/left'); ?>
	<div class="col-md-9 col-sm-9">
		<div id="content">
			<form class="form-horizontal" action="<?= base_url('admin/form/shirtdesign'); ?>" method="post">
			  <div class="form-group">
			    <label class="col-sm-2 control-label">Design name</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" placeholder="Design name" name="designame" required="">
			    </div>
			  </div>
			  <div class="form-group">
