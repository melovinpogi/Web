...
$(document).ready(function(){
	...
	path = 'application/assets/images/product/';
	$dir =  path.substr(0, path.lastIndexOf("/"));

	var path = document.location.pathname;
	var directory = path.substring(path.indexOf('/'), path.lastIndexOf('/'));
	$dir = directory + '/application/assets/images/product';

	$("#preview_images").hide();
	$("#proceed").hide();
	
	//ONLOAD
	$("#preview_front").css('background-image', 'url(assets/customize/images/product/'+$type+'/'+$color+'/'+$color+'_front.png) ') ;
	$("#preview_back").css('background-image', 'url(assets/customize/images/product/'+$type+'/'+$color+'/'+$color+'_back.png) ') ;
	...
	$("#o_front").click(function(){
		$y_pos="front";
				$("#preview_front").css('background-image', 'url(assets/customize/images/product/'+$type+'/'+$color+'/'+$color+'_'+$y_pos+'.png) ') ;
				$("#o_front").attr('src','assets/customize/images/product/'+$type+'/'+$color+'/'+$color+'_front.png');
				$("#o_back").attr('src','assets/customize/images/product/'+$type+'/'+$color+'/'+$color+'_back.png');
	...
	$("#o_back").click(function(){
		$y_pos="back";
				$("#preview_back").css('background-image', 'url(assets/customize/images/product/'+$type+'/'+$color+'/'+$color+'_'+$y_pos+'.png) ') ;
				$("#o_front").attr('src','assets/customize/images/product/'+$type+'/'+$color+'/'+$color+'_front.png');
				$("#o_back").attr('src','assets/customize/images/product/'+$type+'/'+$color+'/'+$color+'_back.png');
...
/*=====================SAMPLE ICONS========================*/
	...
	$(".folder_toggle").click(function(){
		...
		$.ajax({
			      url: 'assets/customize/control/newcontent.php?folder='+$folder,
			      success: function()
		      	{
		        	$("#toggle_show"+$i ).empty().load("assets/customize/control/newcontent.php?folder="+$folder);
		      	}
	    });
	});
/*=====================SAMPLE ICONS over========================*/
