...
class Admin extends CI_Controller {
	...
	public function index(){
		if(user_id() == 0 || user_id() == '' || user_type() != 1 ){
			...
			$data['customers'] = $this->db->query("SELECT id, concat(lastname,', ',firstname) as customer from user where id <> 1")->result();
	...
	public function formedit($menu,$id){
		...
		switch ($menu) {
			case 'brand':
				...
				redirect('admin/edit/brand/' . $id,'refresh');
			...
			case 'color':
				...
				redirect('admin/edit/color/' . $id,'refresh');
			...
			case 'model':
				...
				redirect('admin/edit/model/' . $id,'refresh');
				break;
			...
			case 'shirtdesign':
				...
				redirect('admin/edit/shirtdesign/' . $id,'refresh');
				break;
