...
<?php $this->load->view('menu/left'); ?>
	<div class="col-md-9 col-sm-9">
		<div id="content">
		<?php foreach ($updatebrand as $x) { ?>
			<form class="form-horizontal" action="<?= base_url('admin/formedit/brand/' . $this->uri->segment(4)); ?>" method="post">
			  <div class="form-group">
			    <label class="col-sm-2 control-label">Brand name</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" placeholder="Brand name" name="brandname" required="" value="<?php echo $x->brand_name; ?>">
			    </div>
			  </div>
			  <div class="form-group">
